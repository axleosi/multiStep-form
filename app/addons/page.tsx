...
const AddOns = () => {
  ...
  const handleNextClick = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
    // Check if any checkbox is true (addon selected)
    const anySelected = Object.values(checkbox).some(Boolean);
    if (!anySelected) {
      e.preventDefault();
      setError('Please select at least one add-on before continuing.');
    }
  };
      ...
      <div className={styles.container}>
        <div className={styles.miniCon}>
              ...
              <div className={styles.miniSel}>
                <div className={styles.checkbox}>
                  <input
                    ...
                    onChange={(e) => handleCheckboxChange(e, 'Online service', plan.isActive ? 10 : 1)}
                  />
              ...
              <div className={styles.miniSel}>
                <div className={styles.checkbox}>
                  <input
                    ...
                    onChange={(e) => handleCheckboxChange(e, 'Larger Storage', plan.isActive ? 20 : 2)}
                  />
              ...
              <div className={styles.miniSel}>
                <div className={styles.checkbox}>
                  <input
                    ...
                    onChange={(e) => handleCheckboxChange(e, 'Customizable Profile', plan.isActive ? 20 : 2)}
                  />
          ...
          <div className={styles.buttons}>
            ...
            <Link href='/summary' className={styles.nextStep} onClick={handleNextClick}>Next Step</Link>
          </div>
        </div>
      </div>
    </div>
